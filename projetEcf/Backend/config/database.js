...
await db.query(`CREATE TABLE IF NOT EXISTS "Gift" (
        ID_Gift SERIAL PRIMARY KEY NOT NULL,
        Name varchar NOT NULL,
        Description varchar NOT NULL
   )`);
...
await db.query(`ALTER TABLE "Character" ADD FOREIGN KEY(ID_Gift) REFERENCES "Gift"(ID_Gift)`);
